...
$query = "SELECT  role, count(role)  FROM users  group by role";
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="active">
                            ...
                            <li>
                                <a href="">Créer un categorie</a>
                            </li>
                            <li>
                                <a href="">list des categorie</a>
                            </li>
                        </ul>
                    </li>
