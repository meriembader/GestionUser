...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>SPORT<span>HUB</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">Aziz Alouch<h1>2A23</h1></h5>
          <li class="mt">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="dropzone.html">Ajouter Article</a></li>
              <li><a href="grids.html">Modifier Article</a></li>
              <li><a href="dropzone.html">Supprimer Article Article</a></li>
              <li><a href="calendar.html">Calendar ajouter article</a></li>
              <li><a href="gallery.html">Gallery d'article</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="basic_table.html">Ajouter Abonnement</a></li>
              <li><a href="responsive_table.html">Modifier Abonnement</a></li>
              <li><a href="advanced_table.html">Supprimer Abonnement</a></li>
            </ul>
          </li>
          <li>
            <a href="inbox.html">
