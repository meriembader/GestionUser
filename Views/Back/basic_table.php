  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active">
                <a href="basic_table.php">Ajouter Abonnement</a>
              </li>
              <li>
                <a href="responsive_table.php">Modifier Abonnement</a>
              </li>
              <li>
                <a href="advanced_table.php">Supprimer Abonnement</a>
              </li>
            </ul>
          </li>
          <li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Ajouter abonnement</h3>
    ...
    <div class="row mt-4">
      ...
      <div class="col-md-4 ml-auto pricing-box align-self-center">
        <div class="card mb-4">
         ...
         <form action="../me/views/ajouterabonnement.php" method="post">
      ...
      <div class="col-md-4 ml-auto pricing-box align-self-center">
        <div class="card mb-4">
          <div class="card-body p-4 text-center"><br>
           ...
           <form action="../me/views/ajouterabonnement.php" method="post"><br>
